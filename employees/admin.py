...
class UserCreationForm(ModelForm):
    ...
    class Meta:
        model = Employee
        fields = ('username', 'email', 'last_name', 'first_name', 'middle_name', 'hire_date', )
    ...
    def save(self, commit=True):
        ...
        if not user.username:
            user.username = user.staff_id_number
        if commit:
            user.save()
        return user
...
class UserChangeForm(ModelForm):
    ...
    class Meta:
        model = Employee
        fields = ('username', 'email', 'last_name', 'first_name', 'middle_name', 'hire_date', 'password', 'is_active', 'is_superuser',)
